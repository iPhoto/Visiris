...
@class VSMainTimelineTrackViewController;
 ...
 */
-(BOOL) removeTimelineObject:(VSTimelineObjectViewController*) timelineObjectViewController fromTrack:(VSMainTimelineTrackViewController*) trackViewController;
 ...
 * @param trackViewController VSTrackViewController holding the VSTimelineObjectViewController's view 
 */
-(void) timelineObject:(VSTimelineObjectViewController *)timelineObjectViewController wasDraggedOnTrack:(VSMainTimelineTrackViewController*) trackViewController;
 ...
 */
-(void) timelineObject:(VSTimelineObjectViewController *)timelineObjectViewController willStartDraggingOnTrack:(VSMainTimelineTrackViewController*) trackViewController;
 ...
 */
-(void) timelineObjectProxy:(VSTimelineObjectProxy *) timelineObjectProxy wasSelectedOnTrackViewController:(VSMainTimelineTrackViewController*) trackViewController;
...
-(BOOL) timelineObject:(VSTimelineObjectViewController*) timelineObjectViewController willStartResizingOnTrack:(VSMainTimelineTrackViewController*) trackViewController;

-(void) timelineObject:(VSTimelineObjectViewController*) timelineObjectViewController didStopResizingOnTrack:(VSMainTimelineTrackViewController*) trackViewController;
 ...
 * Pleas write more
 */
@interface VSMainTimelineTrackViewController : VSTrackViewController<VSTrackViewDelegate, VSTimelineObjectControllerDelegate>
