...
#import "VSMainTimelineTrackView.h"
...
@implementation VSMainTimelineTrackViewController


/** Name of the nib that will be loaded when initWithDefaultNib is called */
static NSString* defaultNib = @"VSMainTimelineTrackView";
...
-(void) awakeFromNib{
    ...
    if([self.view isKindOfClass:[VSMainTimelineTrackView class]]){
        
        ((VSMainTimelineTrackView*) self.view).controllerDelegate = self;
    }
...
-(BOOL) trackView:(VSMainTimelineTrackView *)trackView objectsHaveBeenDropped:(id<NSDraggingInfo>)draggingInfo atPosition:(NSPoint)position{
...
-(void) trackView:(VSMainTimelineTrackView *)trackView draggedObjects:(id<NSDraggingInfo>)draggingInfo movedFromPosition:(NSPoint)oldPosition toPosition:(NSPoint)newPosition{
...
-(NSDragOperation) trackView:(VSMainTimelineTrackView *)trackView objectsHaveEntered:(id<NSDraggingInfo>)draggingInfo atPosition:(NSPoint)position{
...
-(BOOL) trackView:(VSMainTimelineTrackView *)trackView objectHaveExited:(id<NSDraggingInfo>)draggingInfo{
...
-(void) didClicktrackView:(VSMainTimelineTrackView *)trackView{
...
/**
 * Calls its delegate to unselect the given timelineObjectProxy
 *
...
/**
 * Calls its delegate to select the given timelineObjectProxy
 *
 * @param timelineObjectProxy VSTimelineObjectProxy to be selected
 * @param exlusively Indicates wheter the currently selected TimelineObjects are unselected or not
 */
-(BOOL) selectTimelineObject:(VSTimelineObjectProxy*) timelineObjectProxy exclusively:(BOOL) exlusively{
    if([self delegateRespondsToSelector:@selector(timelineObjectProxy:willBeSelectedOnTrackViewController:exclusively:)]){
        return [self.delegate timelineObjectProxy:timelineObjectProxy
              willBeSelectedOnTrackViewController:self exclusively:exlusively];
    }
 ...
 */
-(VSTimelineObjectViewController*) addNewTemporaryTimelineObjectProxyBasedOn:(VSProjectItemRepresentation*) aProjectItem atPosition:(NSPoint) aPosition toTrack:(VSMainTimelineTrackView*)aTrackView temporaryID:(NSInteger) temporaryID{
